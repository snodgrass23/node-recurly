(function(){
  ...
  module.exports = function(config){
    ...
    this.subscriptions = {
      ...
      update: function(accountcode, details, callback) {
        t.request('/accounts/' + accountcode +'/subscription', 'PUT', callback, t.js2xml(details,'subscription'));
      },
      reactivate: function(accountcode, details, callback) {
        t.request('/accounts/' + accountcode +'/subscription/reactivate', 'POST', callback, t.js2xml(details,'subscription'));
      },
